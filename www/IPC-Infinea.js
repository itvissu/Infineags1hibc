...
var Infinea = {
    ...
    */
    ...
    {
        cordova.exec(null, null, 'Infinea', 'initWithCallbacks', [ { barcodeStatusCallback: "Infinea._onBarcodeStatus", barcodeDataCallback: "Infinea._onBarcodeData", buttonPressedCallback: "Infinea._onButtonPressed" } ]);
    },

    _onBarcodeStatus: function (available)
    {
        if(this.barcodeStatusCallback!=null)
            this.barcodeStatusCallback(available);
    },
